...
const messages: Messages = {
  ...
  pageActions: {
    ...
    backToInitiative: "Zurück zur Initiative",
    backToInitiatives: "Zurück zu Initiativen",
    initiativePlanNew: "Neue Initiative",
    backToTarget: "Zurück zum Ziel",
    backToTargets: "Zurück zu Zielen",
    targetNew: "Neues Ziel",
