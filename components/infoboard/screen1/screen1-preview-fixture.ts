...
/**
 * INFOBOARD-TEAMNAME-01A acceptance fixture.
 *
 * Canonical Team names remain short (F2/E1/E4) while explicit Infoboard
 * overrides render as JUNIOREN F2 / JUNIOREN E1 / JUNIOREN E4 on Screen 1.
 */
export const PREVIEW_FIXTURE_TEAMNAME_ACCEPTANCE: InfoboardScreen1Feed = {
  generatedAt: "2026-09-12T15:35:00.000Z",
  tenant: PREVIEW_TENANT,
  displayDate: "2026-09-12",
  isStale: false,
  ...
  next: [
    ...
    },
    {
      id: "evt-teamname-e4",
      type: "TRAINING",
      displayTitle: "E4 Training",
      teamDisplayName: "JUNIOREN E4",
      opponentDisplayName: null,
      opponentLogoUrl: null,
      matchPresentation: null,
      organizerDisplayName: "FC Allschwil",
    ...
    {
      id: "evt-teamname-match",
      type: "MATCH",
      displayTitle: "FC Allschwil C2 – FC Opponent C2",
      teamDisplayName: "JUNIOREN C2",
      opponentDisplayName: "FC Opponent C2",
      opponentLogoUrl: PREVIEW_OPPONENT_LOGOS.fcBinningen,
      matchPresentation: {
        home: {
          clubDisplayName: "FC ALLSCHWIL",
        ...
        away: {
          clubDisplayName: "FC OPPONENT",
          teamSubDisplayName: "C2",
          clubLogoUrl: PREVIEW_OPPONENT_LOGOS.fcBinningen,
        },
      },
      organizerDisplayName: null,
      ...
      allocation: {
        pitchLabel: "KR 1",
        homeDressingRoomLabel: "C2",
        awayDressingRoomLabel: "G1",
        refereeDressingRoomLabel: null,
      },
    },
  ],
