import type { PageStatus } from "@/lib/pages/admin-queries";
...
type WebsitePageStatusBadgeProps = {
  status: PageStatus;
};

export default function WebsitePageStatusBadge({ status }: WebsitePageStatusBadgeProps) {
