        ...
        <aside className="space-y-5">
          <section className="overflow-hidden rounded-[30px] border border-slate-200 bg-white shadow-sm">
            ...
            <div className="p-6 text-center">
              <div className="mx-auto flex h-28 w-28 items-center justify-center overflow-hidden rounded-[34px] bg-gradient-to-br from-blue-50 to-red-50 text-3xl font-black text-[#0b4aa2] shadow-sm">
