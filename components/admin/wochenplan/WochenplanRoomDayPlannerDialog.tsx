              ...
              return (
                <div
                  ...
                  className={[
                    ...
                    isActiveDropZone
                      ? "border-[var(--sce-primary)] bg-blue-50/40 shadow-[0_0_0_4px_var(--sce-primary-soft)]"
                ...
                >
                  <div className={"border-r border-slate-200 px-4 py-4 " + roomTone.rowBackgroundClass}>
                    ...
                    {isActiveDropZone ? (
                      <p className="mt-3 text-xs font-semibold uppercase tracking-[0.14em] text-[var(--sce-primary)]">
                        Hier ablegen
                      </p>
                    ) : null}
                  </div>
                          ...
                          return (
                            <div
                              ...
                              className={[
                                ...
                                item.toneClassName,
                                item.glowClassName,
                                isDraggingThisItem ? "opacity-45 ring-2 ring-[var(--sce-primary)]" : "",
                              ].join(" ")}
                              style={{
                ...
                >
                  ...
                  <label className="block">
                    ...
                    <select
                      ...
                      className="w-full rounded-2xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 outline-none transition focus:border-[var(--sce-primary)]"
                    >
