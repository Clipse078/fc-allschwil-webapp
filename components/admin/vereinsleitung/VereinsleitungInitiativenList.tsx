/**
 * TODO: Governance Foundation — Initiative model promotion
 *
 * Currently mocked. When Initiative is promoted to a DB-backed Prisma model,
 ...
 *   - reviewedAt DateTime?
 *
 * WorkflowDomain.INITIATIVES is already registered and ready.
 * Use lib/governance/review-stage.ts helpers for stage transitions.
 * Surface ReviewStageBadge on Initiative list and detail views.
 */
