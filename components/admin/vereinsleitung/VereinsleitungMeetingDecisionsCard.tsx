  ...
  return (
    <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <p className="mt-5 text-sm leading-6 text-slate-600">
        Neue Entscheide werden direkt im traktan­denbasierten Ausführungsbereich erfasst. Aktivierte
        Pendenzen werden beim Speichern automatisch erstellt und ans Meeting zurückgelinkt.
      </p>
    </section>
  );
}
