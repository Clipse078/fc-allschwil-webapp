  ...
  return (
    <section className="rounded-[30px] border border-slate-200/80 bg-white p-7 shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          type="button"
          className="text-sm font-semibold text-[var(--sce-primary)] transition hover:text-[var(--sce-primary-strong)]"
        >
          Alle Tasks
        </button>
      </div>
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-2 flex flex-wrap items-center gap-x-3 gap-y-2 text-xs text-slate-500">
                <span className="inline-flex items-center gap-2">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-[var(--sce-primary-soft)] text-[10px] font-semibold text-[var(--sce-primary)]">
                    {task.ownerInitials}
                  </span>
                  {task.owner}
                </span>
