    ...
    return (
      <section className="rounded-[30px] border border-slate-200/80 bg-white p-7 shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
        <div className="flex items-center gap-2">
          <FileText className="h-4 w-4 text-[#3f63b5]" />
            ...
            {agendaItems.map((item, idx) => (
              <article key={item.id} className="rounded-[24px] border border-slate-200/80 bg-white p-5 shadow-[0_6px_18px_rgba(15,23,42,0.03)]">
                <div className="flex items-start gap-4">
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#3f63b5]/10 text-sm font-semibold text-[#3f63b5]">{idx + 1}</div>
  ...
  return (
    <section className="rounded-[30px] border border-slate-200/80 bg-white p-7 shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
      <div className="flex items-center justify-between gap-4">
        ...
        <button type="button" className="text-sm font-semibold text-[#3f63b5] transition hover:text-[#08357a]">Alle einklappen</button>
      </div>
      <div className="mt-6 space-y-4">
        {MOCK_ITEMS.map((item) => (
          <article key={item.number} className="rounded-[24px] border border-slate-200/80 bg-white p-5 shadow-[0_6px_18px_rgba(15,23,42,0.03)]">
            <div className="flex items-start gap-4">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#3f63b5]/10 text-sm font-semibold text-[#3f63b5]">{item.number}</div>
              <div className="min-w-0 flex-1">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    <h4 className="text-[1rem] font-semibold text-slate-900">{item.title}</h4>
                    <div className="mt-2 flex items-center gap-2">
                      <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#3f63b5]/10 text-[10px] font-semibold text-[#3f63b5]">{item.ownerInitials}</div>
