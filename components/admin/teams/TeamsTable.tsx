        ...
        <div className="space-y-4">
          {filteredTeams.map((team) => (
            <AdminListItem
              key={team.id}
              avatar={
                <div className="flex h-14 w-14 items-center justify-center rounded-full border border-slate-200 bg-gradient-to-br from-white to-slate-100 font-[var(--font-display)] text-sm font-bold uppercase tracking-[0.08em] text-[#3f63b5] shadow-sm">
                  {team.ageGroup ?? "FCA"}
                </div>
              }
