      ...
      {FILTERS.map((filter) => {
        ...
        return (
          <Link
            ...
            className={
              isActive
                ? "inline-flex items-center rounded-full border border-slate-200 bg-gradient-to-br from-white to-slate-50 px-4 py-2 text-sm font-semibold text-[#3f63b5] shadow-sm"
