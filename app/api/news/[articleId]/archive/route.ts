/**
 * POST /api/news/[articleId]/archive
 *
 * Sets status=ARCHIVED (hides from public feed and marks as archived).
 *
...
export async function POST(_request: NextRequest, { params }: Params) {
  ...
  const article = await archiveNewsArticle(articleId, tenantId);
  if (!article) {
