...
export async function getMeetingDetailItem(
  ...
  return {
    ...
    approvalSubmittedAtLabel: formatMeetingDateTimeLabel(meeting.approvalSubmittedAt),
    approvedAtLabel: formatMeetingDateTimeLabel(meeting.approvedAt),
    rejectedAtLabel: formatMeetingDateTimeLabel(meeting.rejectedAt),
    ...
    approvalLockReasonLabel: getMeetingApprovalLockReasonLabel({
      status: meeting.status,
      approvalStatus: meeting.approvalStatus,
    }),
